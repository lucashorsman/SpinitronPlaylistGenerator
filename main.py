...
token = util.prompt_for_user_token(None,scope,client_id='14f23c99c6174bc7843cd7864abc22cc',client_secret='b2d3a6bbebe24e69a78b98a446471072',redirect_uri='https://localhost:8080')
...
#create a playlist
playlist = spotify.user_playlist_create(user, 'In The Garage-Generated2', public=True, collaborative=False, description='')
